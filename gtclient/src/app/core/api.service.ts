...
import { DmtResponse } from '../model/dmt.response';
...
export class ApiService {
    ...
    updateUser(group: Group): Observable<Group> {
        return this.http.put<Group>(this.baseUrl + '/group/' + group.groupLoginName, group);
    }
